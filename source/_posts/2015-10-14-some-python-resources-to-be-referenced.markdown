...
(a collection of use python libraries)

http://www.fullstackpython.com/django.html
(shows resources about being a full stack python developer)

http://www.fullstackpython.com/best-python-resources.html
(cool python resources)
